...
from TSforecastingDatasets import TimeSeriesDataset
from TSforecastingModels import LSTMModel, TimeSeriesTransformer
...
def trainSingleGPU(args):
    ...
    # Make Dataset
    trainDataset = TimeSeriesDataset(args.dataDir, trainStartDate, trainEndDate,
    ...
    if useValSet:
        ...
        valDataset = TimeSeriesDataset(args.dataDir, valStartDate, valEndDate,
    ...
    model = TimeSeriesTransformer(input_features, d_model=32, nhead=4, num_layers=1, output_size = output_steps)
